...
class Form(forms.BaseForm):
    ...
    def to_settings(self, data, settings):
        ...
        settings["DJANGO_MULTISITE_PLUS_REWRITE_DOMAINS"] = boolean_ish(
            env(
        ...
        settings["DJANGO_MULTISITE_PLUS_AUTO_POPULATE_SITES"] = boolean_ish(
            env(
                "DJANGO_MULTISITE_PLUS_AUTO_POPULATE_SITES",
                data["auto_populate_sites"],
            )
        )
        settings["DJANGO_MULTISITE_PLUS_USE_REAL_DOMAIN"] = boolean_ish(
            env(
